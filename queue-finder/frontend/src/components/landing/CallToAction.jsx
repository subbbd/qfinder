...
export default function CallToAction() {
  return (
    <section className="bg-brand-orange py-20 px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            to="/explore"
            className="bg-white text-brand-orange font-bold px-8 py-4 rounded-xl text-base hover:bg-brand-orange-light transition-all"
          >
            Explore Stores
          </Link>
          <Link
